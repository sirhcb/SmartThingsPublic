...
definition(
    ...
    description: "Starts a dimmer switch at a given percentage, then lowers it slowly based on an interval provided until it gets to zero, then turns off the light.",
    category: "Family",
